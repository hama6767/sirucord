...
基本監視は毎時17分・47分（48回/日）です。どこかの対象チャンネルに人がいることを確認すると、`Active Discord checks` を有効にして残りの5分刻みの確認を追加します。すべて無人なら追加監視自体を無効にします。1日中人がいる場合は合計288回/日です。無人から最初の参加を検知するまでには最大約30分とActionsの遅延があり、その後に5分間隔へ移ります。Botだけなら無人扱いです。
